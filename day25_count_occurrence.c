...
int countoccurence (struct node* head,int key) {
    struct node* temp = head;
    int count = 0;
...
int main () {
    ...
    int key;
    printf("Enter the element to find it's occurrrence:");
    scanf("%d",&key);

    printf("Total occurrence of element %d in this linked list is:%d",key,countoccurence(head,key));
